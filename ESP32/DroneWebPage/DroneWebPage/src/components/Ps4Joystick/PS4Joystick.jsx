    ...
    <div className='ps4-container'>
        <svg width="350" viewBox="0 0 441 383" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="XBox">
                ...
                <circle id="LeftStick" cx={setStickPos(113.04705953598022, 0)} cy={setStickPos(160.04705953598022, 1)} r="28" fill={getAxis(0, 1)} stroke="rgba(0,0,0,1)" strokeWidth="3"></circle>
                <circle id="RStickOutline" cx="278" cy="238" r="37.5" stroke="hsl(210,50%,85%)" strokeOpacity="1" strokeWidth="3"></circle>
                <circle id="RightStick" cx={setStickPos(278.0470595359802, 2)} cy={setStickPos(238.04705953598022, 3)} r="28" fill={getAxis(2, 3)} stroke="rgba(0,0,0,1)" strokeWidth="3"></circle>
                ...
                <g id="DUp">
                    ...
                    <path d="M177.669 222.335C180.793 219.21 180.816 213.997 176.868 212.014C176.327 211.743 175.776 211.491 175.215 211.258C172.182 210.002 168.931 209.355 165.648 209.355C162.365 209.355 159.114 210.002 156.081 211.258C155.521 211.491 154.969 211.743 154.429 212.014C150.48 213.997 150.503 219.21 153.627 222.335L159.991 228.698C163.116 231.823 168.181 231.823 171.305 228.698L177.669 222.335Z" 
                    fill={getButtonPressed(12)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-8-inside-1)"></path>
                </g>
                <g id="DRight">
                    ...
                    <path d="M181.447 249.669C184.571 252.793 189.785 252.816 191.768 248.868C192.039 248.327 192.291 247.776 192.523 247.215C193.78 244.182 194.426 240.931 194.426 237.648C194.426 234.365 193.78 231.114 192.523 228.081C192.291 227.521 192.039 226.969 191.768 226.429C189.785 222.48 184.571 222.503 181.447 225.627L175.083 231.991C171.959 235.116 171.959 240.181 175.083 243.305L181.447 249.669Z" 
                    fill={getButtonPressed(15)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-9-inside-2)"></path>
                </g>
                <g id="DDown">
                    ...
                    fill={getButtonPressed(13)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-10-inside-3)"></path>
                </g>
                <g id="DLeft">
                    ...
                    fill={getButtonPressed(14)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-11-inside-4)"></path>
                </g>
                ...
                <g id="BTop">
                    ...
                    fill={getButtonPressed(3)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-13-inside-5)"></path>
                </g>
                <g id="BRight">
                    ...
                    fill={getButtonPressed(1)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-14-inside-6)"></path>
                </g>
                <g id="BBottom">
                    ...
                    fill={getButtonPressed(0)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-15-inside-7)"></path>
                </g>
                <g id="BLeft">
                    ...
                    fill={getButtonPressed(2)} stroke="rgba(0,0,0,1)" strokeWidth="6" mask="url(#path-16-inside-8)"></path>
                </g>
                <g id="LMeta">
                    <circle cx="185" cy="162" r="10" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" strokeWidth="3"></circle>
                </g>
                <g id="RMeta">
                    <circle cx="259" cy="162" r="10" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" strokeWidth="3"></circle>
                </g>
